...
#ifndef __Homework_1__Sequence__
#define __Homework_1__Sequence__
...
public:
    ...
    Sequence(int a);    //sequence for inputing ints for casssert later on 
